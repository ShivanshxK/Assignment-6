...
student_data(student_id="21102034")
student_data(student_id="21102034",student_name="Shivansh Khurana")
student_data(student_id="21102034",student_name="Shivansh Khurana",student_class="1st Year")
print()
